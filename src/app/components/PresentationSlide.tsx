...
const PresentationSlide = () => {
  return (
    <div className="w-full h-full flex items-center justify-center bg-[#111] p-4 sm:p-8 overflow-hidden">
      ...
      >
        ...
        {/* 1. Base Gradient */}
        <div className="absolute inset-0 bg-radial-[circle_at_50%_50%] from-[#1a1a1a] to-black opacity-80" />
        ...
        {/* 4. Red Glow Accents */}
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-[#FF0000] opacity-5 blur-[150px] rounded-full" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-[#FF0000] opacity-5 blur-[120px] rounded-full" />
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-16">
          ...
          <div className="relative h-16 flex items-end justify-between border-t border-white/10 pt-4">
            ...
            <div className="z-10 bg-black/50 backdrop-blur-sm px-4 py-2 flex items-center gap-2">
              <span className="text-sm font-bold tracking-widest">START PRESENTATION</span>
